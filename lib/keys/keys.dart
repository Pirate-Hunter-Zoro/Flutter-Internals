          ...
          child: Column(
            children: [
              ...
              for (final todo in _orderedTodos)
                // THE KEY IS IMPORTANT - see explanation in the CheckableTodoItem class creation...
                CheckableTodoItem(
                  key: ValueKey(todo.text), // ObjectKey() also works, but it's less lightweight behind the scenes...
                  todo.text,
                  todo.priority,
                ),
            ],
